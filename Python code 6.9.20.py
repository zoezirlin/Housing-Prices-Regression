...
predictions = model_2.predict(X) # make the predictions by the model
...
## Transformating the data, power transform family of functions
# https://docs.scipy.org/doc/scipy/reference/generated/scipy.stats.boxcox.html
# https://www.kaggle.com/rtatman/boxcox-transform-on-train-test-data
# Boxcox transformation

train_fitted, fitted_lambda = stats.boxcox(train_final)
